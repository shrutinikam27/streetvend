...
<<<<<<< HEAD
                  <div className="bg-gradient-to-r from-orange-100 via-orange-50 to-orange-100 border-2 border-dashed border-orange-300 rounded-2xl w-full min-h-96 p-6 md:col-span-2">
                    <div className="text-center">
                      ...
                      <h3 className="text-2xl font-bold text-gray-800 mt-6 mb-2">Vendor Dashboard Interface</h3>
                      <p className="text-gray-600 font-medium max-w-lg mx-auto">Manage your entire street food business from one powerful, intuitive interface designed for growth.</p>
                    </div>
                  </div>
                </>
              ) : activeTab === 'supplier' ? (
...
<<<<<<< HEAD
                  ...
                  <div className="bg-gradient-to-r from-orange-100 via-orange-50 to-orange-100 border-2 border-dashed border-orange-300 rounded-2xl w-full min-h-96 p-6 md:col-span-2">
                    <div className="text-center">
                      ...
                      />
                      <h3 className="text-2xl font-bold text-gray-800 mt-6 mb-2">Supplier Supply Chain Hub</h3>
                      <p className="text-gray-600 font-medium max-w-lg mx-auto">Optimize your supply chain with real-time analytics and seamless vendor collaboration tools.</p>
                    </div>
                  </div>
                </>
              ) : (
                <>
                  <DashboardCard
                    ...
                    title="Real-time Map"
                    description="High-precision GPS tracking with glowing routes and live traffic status."
                  />
                  <DashboardCard
                    icon={<FaTruck className="text-orange-500 text-xl" />}
                    title="Fleet Monitoring"
                    description="Monitor all delivery agents on a single interactive city-scale viewport."
                  />
                  <DashboardCard
                    icon={<FaClipboardList className="text-orange-500 text-xl" />}
                    title="Dispatch Queue"
                    description="Manage upcoming deliveries and assign drivers with intelligent routing."
                  />
                  <DashboardCard
                    icon={<FaMapMarkerAlt className="text-orange-500 text-xl" />}
                    title="Wait Time Analytics"
                    description="Reduce idling time and improve delivery efficiency with real-time predictions."
                  />
                  {/* Visual Tracking Preview Area */}
                  <div className="bg-gradient-to-r from-orange-100 via-orange-50 to-orange-100 border-2 border-dashed border-orange-300 rounded-2xl w-full min-h-96 p-6 md:col-span-2">
                    <div className="text-center">
                      <img
...
<<<<<<< HEAD
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button 
              ...
              className="px-10 py-4 bg-white text-orange-500 rounded-lg hover:bg-gray-100 transition-all duration-300 font-medium text-lg transform hover:scale-105 shadow-xl"
            >
              Sign Up as Vendor
            </button>
            <button 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-2xl font-black text-white tracking-tighter">StreetVend</span>
              </div>
              <p className="text-gray-400 leading-relaxed mb-8">
                Revolutionizing the street food supply chain in Satara. We empower vendors and suppliers with real-time tracking, transparent pricing, and seamless logistics.
              </p>
              <div className="flex gap-4">
                {[FaFacebookF, FaTwitter, FaInstagram, FaLinkedinIn].map((Icon, idx) => (
                  <a key={idx} href="#" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 hover:bg-orange-500 hover:text-white transition-all duration-300 transform hover:-translate-y-1">
                    <Icon />
                  </a>
                ))}
              </div>
            ...
            <div className="grid grid-cols-2 gap-8 lg:col-span-2">
              <div>
                <h4 className="text-white font-bold mb-6 uppercase tracking-widest text-xs">For Businesses</h4>
                <ul className="space-y-4">
                  {['Find Suppliers', 'Become a Supplier', 'Order Tracking', 'Price Trends', 'Business Loans'].map(item => (
                    <li key={item}>
                      <a href="#" className="text-gray-400 hover:text-orange-500 transition-colors text-sm font-medium">{item}</a>
                    </li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-4">
                   {['Market Insights', 'Food Safety', 'Vendor Stories', 'Support Center', 'Legal Policy'].map(item => (
                    <li key={item}>
                      <a href="#" className="text-gray-400 hover:text-orange-500 transition-colors text-sm font-medium">{item}</a>
                    </li>
                  ))}
            ...
            <div>
               ...
               <p className="text-gray-400 text-sm mb-6">Receive weekly market price alerts and exclusive supplier discounts.</p>
               <form className="relative group">
                 <input 
                  type="email" 
                  placeholder="name@email.com" 
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-4 text-white text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all font-sans"
                 />
                 <button className="absolute right-2 top-2 bottom-2 px-4 bg-orange-600 hover:bg-orange-700 text-white rounded-xl text-xs font-black transition-all">
                   JOIN
                 </button>
               </form>
               <div className="mt-8 pt-8 border-t border-white/5">
                  <p className="text-xs text-gray-500 flex items-center gap-2">
                    ...
                    Plot No. 42, Powai Naka, Satara, Maharashtra 415001
                  </p>
               </div>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-xs font-medium">
              &copy; 2026 StreetVend Technologies. All rights reserved.
            </p>
            <div className="flex gap-8">
              <a href="#" className="text-gray-500 hover:text-white text-[10px] font-bold uppercase tracking-widest">Privacy Policy</a>
              <a href="#" className="text-gray-500 hover:text-white text-[10px] font-bold uppercase tracking-widest">Terms of Service</a>
              <a href="#" className="text-gray-500 hover:text-white text-[10px] font-bold uppercase tracking-widest">Cookie Policy</a>
            </div>
          </div>
        </div>
      </footer>
